...
class LoggerConfig:
    ...
    def mkdir(self):
        ...
        for i in self.corpus:
            ...
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_head_wise_finetune"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_layer_wise_finetune"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_head_wise_probing"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_layer_wise_probing"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_head_wise_probing"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_head_wise_finetune"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_layer_wise_probing"), exist_ok=True)
            os.makedirs(os.path.join(self.checkpoints, i, "XLM-R_layer_wise_probing"), exist_ok=True)
