...
for lang in ${pawsx_Languages[@]}; do
    # pawsx dataset
    python run_paswx.py --model_name_or_path "//home/weicheng/data_interns/yuansui/models/finetune-pawsx-mbert-en-all" --language $lang  --do_eval --num_train_epochs 2.0 --max_seq_length 128 --overwrite_output_dir  --output_dir "//home/weicheng/data_interns/yuansui/models/baseline" --save_steps 10000 --per_gpu_train_batch_size 32 --learning_rate 5e-5  --warmup_steps 1200 --weight_decay 0.1
    python run_paswx.py --model_name_or_path "//home/weicheng/data_interns/yuansui/models/finetune-pawsx-xlm-base-en-all" --language $lang --do_eval --num_train_epochs 2.0 --max_seq_length 128 --overwrite_output_dir  --output_dir "//home/weicheng/data_interns/yuansui/models/baseline" --save_steps 10000 --per_gpu_train_batch_size 32 --learning_rate 5e-5  --warmup_steps 1200 --weight_decay 0.1
done
for lang in ${xnli_Languages[@]}; do
    # finetune on xnli using xlm model
    python run_xnli.py --model_name_or_path "//home/weicheng/data_interns/yuansui/models/finetune-xnli-xlm-base-en-all" --language $lang --do_eval --num_train_epochs 2.0 --max_seq_length 256 --overwrite_output_dir  --output_dir "//home/weicheng/data_interns/yuansui/models/baseline" --save_steps 10000 --per_gpu_train_batch_size 32 --learning_rate 5e-5  --warmup_steps 1200 --weight_decay 0.1
    python run_xnli.py --model_name_or_path "//home/weicheng/data_interns/yuansui/models/finetune-xnli-mbert-en-all" --language $lang --do_eval --num_train_epochs 2.0 --max_seq_length 256 --overwrite_output_dir  --output_dir "//home/weicheng/data_interns/yuansui/models/baseline" --save_steps 10000 --per_gpu_train_batch_size 32 --learning_rate 5e-5  --warmup_steps 1200 --weight_decay 0.1
done
