...
def entropy(p):
    ...
    plogp = p * torch.log(p)
    plogp[p == 0] = 0 # log(0) = inf, meaningless.
...
def compute_heads_importance(
    ...
    head_mask.requires_grad_(requires_grad=True) # head_mask needs to be gradient?
...
def mask_heads(args, model, eval_dataloader):
    """This method shows how to mask head (set some heads to zero), to aaaa.py.py the effect on the network,
